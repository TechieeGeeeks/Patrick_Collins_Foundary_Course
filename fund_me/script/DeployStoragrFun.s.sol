...
contract DeployFundMe is Script {
    function run() external returns (FunWithStorage) {
        ...
        printFirstArrayElement(address(funWithStorage),funWithStorage);
    ...
    function printFirstArrayElement(address contractAddress, FunWithStorage funWithStorage) public  {
        ...
        console.logBytes32(value);
        funWithStorage.doStuff(444);
        bytes32 lenghtOfArray = (vm.load(contractAddress, bytes32(uint256(2))));
        console.log("Lenght OF array at storage slot 2 is : " );
        console.logBytes32(bytes32(lenghtOfArray));
